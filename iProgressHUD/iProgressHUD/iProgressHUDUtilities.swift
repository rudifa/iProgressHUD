...
internal class iProgressHUDUtilities {
    ...
    @MainActor internal static func blurEffect(view: UIImageView, corner: CGFloat) {
    ...
    @MainActor internal static func getSizeUILabel(label: UILabel) -> CGSize {
    ...
    @MainActor internal static func getXPercent(view: UIView, percent: CGFloat) -> CGFloat {
        return view.bounds.width - (view.bounds.width * ((100 - percent) / 100))
    }
    
    @MainActor internal static func getYPercent(view: UIView,percent: CGFloat) -> CGFloat {
        return view.bounds.height - (view.bounds.height * ((100 - percent) / 100))
    }
    
    @MainActor internal static func getWidthPercent(view: UIView,percent: CGFloat) -> CGFloat {
        return view.bounds.width * (percent / 100)
    }
    
    @MainActor internal static func getHeightPercent(view: UIView,percent: CGFloat) -> CGFloat {
        return view.bounds.height * (percent / 100)
    }
    
    @MainActor internal static func getWidthScreen() -> CGFloat {
        return UIScreen.main.bounds.width
    }
    
    @MainActor internal static func getHeightScreen() -> CGFloat {
